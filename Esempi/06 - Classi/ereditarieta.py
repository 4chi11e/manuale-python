...
a = Persona("Antonietta", "Luzzi", 79, "Vimercate")
print(a.scheda_personale())

b = Insegnante("Francesco", "Tormene", 36, "Vimercate", ["Informatica", "Cazzeggio"])
Insegnante.profilo="Fenomeno"
print(b.scheda_personale())
...
class Dizionario:
    ...
    # # permettere di iterare nel dizionario (difficile e non funzionante)
    # def __iter__(self):
    #     if self.radice == None:
    #         return None
    #     else:
    #         self.currKey = self.firstKey(self.radice)
    #         return self.currKey
    
    # def firstKey(self, nodo):
    #     if nodo.sx != None:
    #         return self.firstKey(nodo.sx)
    #     else:
    #         return nodo.key
    
    # def __next__(self):
    #     if self[self.currKey].dx != None:
    #         return self.firstKey(self.currKey.dx)
    #     else:
    #         return self.prossimo(self.radice)
    
    # def prossimo(self, nodo):
    #     if nodo.key > self.currKey:
    #         if nodo.sx.key == self.currKey:
    #             self.currKey = nodo.key
    #             return self.currKey
    #         else:
    #             return self.prossimo(nodo.sx)
